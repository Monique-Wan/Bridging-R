rm(list=ls())
setwd("/Volumes/GoogleDrive/My Drive/Teaching/PG_Bridging/R")
...
# Import data
library(foreign)
grel = read.spss("/Volumes/GoogleDrive/My Drive/Teaching/PG_Bridging/R/NILT2012GR.sav", to.data.frame = TRUE)
colnames(grel)
attach(grel)
table(nkids)
detach(grel)
...
library(foreign)
churn = read.arff(file="churn.arff")
